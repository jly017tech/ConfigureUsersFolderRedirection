...
<p>
  In the picture as it show, I created OU called Design and created a user name John Lee.
  I also create group called Folder Redirection where I add John, so I can see whatever a file will store in the Folder Redirection. 
</p>
